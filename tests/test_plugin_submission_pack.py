...
for phrase in ['Submission type: **Skills only**','## Plugin name','## Short description','## Long description','## Website','## Support URL','## Privacy policy URL','## Terms URL','## Starter prompts','Mission Control','IDX / MLS','Website Operations Specialist','Agency Operations Control Center','John Mark Bataller']:
...
for phrase in ['Agency Operations Control Center','Website Operations Specialist','Real Estate IDX / MLS','RESO Web API','idx-compliance-review','102 composable skills']:
    assert phrase in release, phrase
checklist=(PACK/'SUBMISSION_CHECKLIST.md').read_text(encoding='utf-8')
for phrase in ['Apps Management: Write','individual verification','business verification','Skills only','Submit for Review',f'devmesh-chatgpt-v{VERSION}.zip','102 bundled playbooks']:
