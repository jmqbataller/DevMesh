...
This checklist is for the **skills-only** DevMesh v0.9.0 submission.

## Already prepared

- [x] Public GitHub repository
- [x] Production logo
- [x] ChatGPT Agent Skill source with 65 bundled playbooks
- [x] Automated GitHub Release asset: `devmesh-chatgpt-v0.9.0.zip`
- [x] Listing copy, website, support, privacy, terms, starter prompts
- [x] Five positive + three negative reviewer test cases
- [x] v0.9 release notes
...
- [x] WordPress Real Estate Specialist, Site Doctor, conflict detection, safe updates, WP-CLI, REST, IDX provider/bridge/search/freshness/compliance/VOW, performance, security, lead QA, and client handover playbooks
...
6. Upload the GitHub Release `devmesh-chatgpt-v0.9.0.zip`.
...
15. Verify DevMesh in the Plugins Directory and run Mission Control, WordPress/IDX, full-stack, Quick/Deep, and negative-boundary smoke tests.
...
- Upload bundle: GitHub Release `v0.9.0` → `devmesh-chatgpt-v0.9.0.zip`
