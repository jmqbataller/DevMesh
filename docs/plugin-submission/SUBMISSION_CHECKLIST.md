...
This checklist is for the **skills-only** DevMesh v1.0.0 submission.

## Already prepared

- [x] Public GitHub repository
- [x] Production logo
- [x] ChatGPT Agent Skill source with 81 bundled playbooks
- [x] Automated GitHub Release asset: `devmesh-chatgpt-v1.0.0.zip`
...
- [x] Website Operations Specialist workflows for hosting/DNS/SSL, migrations, restore drills, SEO, Core Web Vitals, analytics, email, links/redirects, plugin/theme risk, WP-Cron, RESO drift/provider inspection, emergency recovery and client reporting
...
6. Upload the GitHub Release `devmesh-chatgpt-v1.0.0.zip`.
...
15. Verify DevMesh in the Plugins Directory and run Website Specialist, WordPress/IDX, Mission Control, full-stack, Quick/Deep, emergency-recovery, and negative-boundary smoke tests.
...
- Upload bundle: GitHub Release `v1.0.0` → `devmesh-chatgpt-v1.0.0.zip`
