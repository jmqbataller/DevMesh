...
This checklist is for the **skills-only** DevMesh v0.7.0 submission.

## Already prepared

- [x] Public GitHub repository
- [x] Production logo
- [x] ChatGPT Agent Skill source with 45 bundled playbooks
- [x] Automated GitHub Release asset: `devmesh-chatgpt-v0.7.0.zip`
- [x] Listing copy, website, support, privacy, terms, starter prompts
- [x] Five positive + three negative reviewer test cases
- [x] v0.7 release notes
...
6. Upload the GitHub Release `devmesh-chatgpt-v0.7.0.zip`.
...
15. Verify DevMesh in the Plugins Directory and run Mission Control, Quick, Deep, and negative-boundary smoke tests.
...
- Upload bundle: GitHub Release `v0.7.0` → `devmesh-chatgpt-v0.7.0.zip`
